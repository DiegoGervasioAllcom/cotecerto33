...
**Estado atual:** V10 fechado para go-live (28/07/2026) — em produção. Próxima
frente: V11.
...
Login de desenvolvimento (seed): `desenvolvimento@suppercerto.com.br` / `Supper@123!` (perfil Matriz).
...
Detalhes completos: **[docs/DOC_TECNICA_V10.md](docs/DOC_TECNICA_V10.md)**.
...
| [`docs/DOC_TECNICA_V10.md`](docs/DOC_TECNICA_V10.md)               | arquitetura implementada e regras técnicas         |
| [`docs/ANALISE_LACUNAS_V10.md`](docs/ANALISE_LACUNAS_V10.md)       | estado atual, entregas e pendências                |
| [`docs/PLANO_TASKS_V10.md`](docs/PLANO_TASKS_V10.md)               | execução das tasks originais e matriz de evidências |
| [`docs/clickup_tasks_v10.csv`](docs/clickup_tasks_v10.csv)         | catálogo original das tasks (imutável)             |
| [`docs/MAPA_PROTOTIPO_PERFIS.md`](docs/MAPA_PROTOTIPO_PERFIS.md)   | comportamento esperado por perfil, tela a tela     |
| [`docs/Q3_DIVERGENCIAS_PROTOTIPO.md`](docs/Q3_DIVERGENCIAS_PROTOTIPO.md) | divergências visuais vs. protótipo            |
...
| [`cotecerto_prototipo_v10.html`](cotecerto_prototipo_v10.html)     | especificação viva de UX (protótipo canônico)      |
