...
function Page() {
  ...
  const [filtro, setFiltro] = useState<"todas" | "global" | "pessoal">("todas");
  ...
  const filtered = rows.filter((m) => filtro === "todas" || m.escopo === filtro);
  ...
  return (
    <AppShell title="Mensagens">
      ...
      <div className="page-head">
        <div>
          <h1>Mensagens</h1>
          <div className="sub">Templates globais (Matriz) e mensagens pessoais</div>
        </div>
