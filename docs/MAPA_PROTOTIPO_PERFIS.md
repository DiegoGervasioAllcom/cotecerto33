...
- **Rafinha (vendedor):** home → Atender agora (assume lead) → Novo lead/cotação → compara seguradoras → _Solicitar desconto adicional_ (se precisar) → proposta → aceite → extrato.
