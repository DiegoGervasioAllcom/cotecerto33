...
| V11.9.7 | front+testes       | **Pagamento real no cálculo Quiver:** no passo 6, substituir as parcelas sintéticas “À vista–12x” pelas condições de `quiver_resultado_raw.cards[].premiosPorFormaPagamento`; ao trocar forma ou condição, atualizar os valores do card e transmitir exatamente a opção selecionada, sem inferir valores ausentes.                                                                                                                                                              | integração Quiver existente |
