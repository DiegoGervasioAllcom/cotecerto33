-- ===========================================================================
-- Remove campo descontinuado do wizard de cotação (23/08/2026)
--
-- - cotacao_perfil.profissao (text) — campo descontinuado; distinto de
--   cotacao_perfil.profissao_principal_condutor, que continua existindo.
-- ===========================================================================

-- ---------- drop da constraint de tamanho ----------
alter table public.cotacao_perfil
  drop constraint if exists cotacao_perfil_profissao_tamanho;

-- ---------- drop da coluna ----------
alter table public.cotacao_perfil
  drop column if exists profissao;

-- ---------- salvar_cotacao_rascunho sem o campo removido ----------
