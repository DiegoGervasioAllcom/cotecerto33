-- ===========================================================================
-- Onda 3 / R.8 — grava os 5 campos novos de "Dados da apólice anterior"
-- (sucursal_anterior, cobertura_anterior, status_apolice_anterior,
-- inicio_vigencia_anterior, fim_vigencia_anterior) adicionados em
-- 20260817010000_cotacao_seguro_apolice_anterior_full.sql. Mesma assinatura
-- da versão anterior (20260804160000_lead_manual_origem_canal.sql): apenas
-- `create or replace`, sem drop. Corpo idêntico, só o upsert de
-- cotacao_seguro ganha as 5 colunas novas, extraídas de p_payload->'seguro'
-- com as mesmas chaves das colunas (mesmo padrão de cia_atual/apolice_atual).
-- ===========================================================================
