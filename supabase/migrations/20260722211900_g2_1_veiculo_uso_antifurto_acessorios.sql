...
alter table public.cotacao_veiculo
  ...
  add column if not exists leilao                    text,
  ...
  add column if not exists hdi_seguros_basico         boolean,
...
alter table public.cotacao_veiculo
  ...
  drop constraint if exists cotacao_veiculo_leilao_tam,
  add  constraint cotacao_veiculo_leilao_tam check (char_length(leilao) <= 150),
